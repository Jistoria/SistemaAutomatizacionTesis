...
class SetMenus extends Command
{
    ...
    public function handle()
    {
        ...
        $menusAdminTesis = [
            ...
            [
            'name' => 'Estudiantes',
            'url' => '/panel/admin_tesis_panel/adminTesisStudentScreen',
            'icon' => 'bi bi-person-vcard-fill',
            'orden' => 1,
            ],
            [
            'name' => 'Docentes',
            'url' => '/panel/admin_tesis_panel/adminTesisDocentScreen',
            ...
            [
            'name' => 'Procesos',
            'url' => '/panel/admin_tesis_panel/adminTesisProcessScreen',
