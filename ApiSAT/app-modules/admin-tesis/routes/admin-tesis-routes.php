...
// Route::get('/admin-teses', [AdminTesisController::class, 'index'])->name('admin-teses.index');
// Route::get('/admin-teses/create', [AdminTesisController::class, 'create'])->name('admin-teses.create');
// Route::post('/admin-teses', [AdminTesisController::class, 'store'])->name('admin-teses.store');
// Route::get('/admin-teses/{admin-tesi}', [AdminTesisController::class, 'show'])->name('admin-teses.show');
